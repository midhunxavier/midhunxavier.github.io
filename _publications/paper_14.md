...
citation: "M. Xavier, V. Dubinin, S. Patil, V. Vyatkin. \"A framework for the generation of monitor and plant model from event logs using process mining for formal verification of event-driven systems.\" <i>IEEE Open Journal of the Industrial Electronics Society</i>, 2024."
---
